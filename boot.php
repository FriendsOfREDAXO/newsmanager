...
rex_extension::register('REX_FORM_SAVED', 'NewsManager::generateRssFeeds', rex_extension::LATE);
rex_extension::register('REX_FORM_DELETED', 'NewsManager::generateRssFeeds', rex_extension::LATE);
rex_extension::register('REX_LIST_GET', 'NewsManager::generateRssFeeds', rex_extension::LATE);
